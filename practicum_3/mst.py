...
def prim_mst(G: nx.Graph, start_node="0") -> set[tuple[Any, Any]]:
    ...
    # Cons:
    # 1. Each time we go through the whole mst_set
    # even though we have already known the
    # connections of their elements (would it
    # be easier to support the set of new edges?)
    # 2. A bit verbose
